  ...
  return (
    <>
      ...
      <div className="container fillFormContainer" style={{ marginTop: "10vh" }}>
        <h2 className='specialText fs-3 text-md-center'>Fill Travel Forms </h2>
        <form onSubmit={handleSubmit} className='fillForm'>
        
       
          <div className="form-group mt-2">
            <label htmlFor="formType">Type of Form to Fill</label>
            <select
              className="form-control"
              id="formType"
              onChange={(e) => setFormType(e.target.value)}
            >
                <option value="Embassady Form">Embassady Form</option>
                <option value=">Hotel Reservation">Hotel Reservation</option>
                <option value="Flight Form">Flight Form</option>
                <option value="Flight Form + Hotel Reservation">Flight Form + Hotel Reservation</option>
            </select>
          </div>
          <div className="form-group mt-2">
          ...
          <div className="container d-flex justify-content-center flex-column align-items-center mt-2">
            ...
            <p className='priceNotes  fs-5'>Service cost will be determined after contacting one of our customer service representatives.</p>
          </div>
